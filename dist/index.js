(function (global, factory) {
	...
	const CountDown = (props) => {
	    ...
	    // 暂停时间
	    const countRef = react.exports.useRef(time);
	    // 获取每次 render 的 time
	    const timeRender = react.exports.useRef(0);
	    // 是否暂停
	    const refRun = react.exports.useRef(true);
	    // 记录 requestAnimation id
	    const refId = react.exports.useRef(0);
	    const [renderTime, setRenderTime] = react.exports.useState({
	        hour: 0,
	        minute: 0,
	        secound: 0,
	        millisecond: 0
